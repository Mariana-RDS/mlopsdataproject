...
from mlopsdataproject import download_data
from mlopsdataproject import plot_stock_data  
from mlopsdataproject.utils.get_current_date import get_current_date
